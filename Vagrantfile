...
Vagrant.configure("2") do |config|
    ...
    # Configure our project to use Official Ubuntu 22.04.5 LTS (Jammy Jellyfish) (https://portal.cloud.hashicorp.com/vagrant/discover/ubuntu/jammy64)
